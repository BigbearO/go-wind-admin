...
func (_q *GameAccountQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *GameAccountQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *GameAccountQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *GameAccountQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *GameAccountQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *GameAccountQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(gameaccount.FieldCreatedBy).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.GameAccount.Query().
//		Select(gameaccount.FieldCreatedBy).
//		Scan(ctx, &v)
...
func (_q *GameAccountQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(gameaccount.Table, gameaccount.Columns, sqlgraph.NewFieldSpec(gameaccount.FieldID, field.TypeUint32))
	_spec.From = _q.sql
