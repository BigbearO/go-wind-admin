...
func (c *GameAccountClient) UpdateOneID(id uint32) *GameAccountUpdateOne {
...
func (c *GameAccountClient) DeleteOneID(id uint32) *GameAccountDeleteOne {
...
func (c *GameAccountClient) Get(ctx context.Context, id uint32) (*GameAccount, error) {
	return c.Query().Where(gameaccount.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *GameAccountClient) GetX(ctx context.Context, id uint32) *GameAccount {
